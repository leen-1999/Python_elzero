...
class Member:
    ...
    def __init__(self, name):
        ...
        self._name = name  # Protected but you access and change there is no restriction
...
one = Member("Ahmed")
# print(one.__name) # gives error
print(one.say_hello())
print(one._Member__name)  # you can access the private att.
