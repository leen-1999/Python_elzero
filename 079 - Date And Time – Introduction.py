...
import datetime  # it is a module
...
# Print Specific Date
print(datetime.datetime(1982, 10, 25))  # year, month, day are mendatory
print(datetime.datetime(1982, 10, 25, 10, 45, 55, 150364))

print("#" * 40)

myBirthDay = datetime.datetime(1982, 10, 25)  # year, month, day are mendatory
